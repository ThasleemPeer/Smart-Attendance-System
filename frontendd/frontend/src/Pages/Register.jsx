...
import { Camera, User, Mail, CheckCircle, AlertCircle, Loader2 } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-tr from-indigo-900 via-purple-900 to-black p-6">
      <div className="relative bg-gray-900/80 backdrop-blur-md p-8 rounded-3xl shadow-2xl w-full max-w-4xl border border-indigo-500/30 flex gap-6">
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-gray-800 border border-indigo-500/50 rounded-xl text-white"
                  required
                />
              </div>
            ...
            <button
              ...
              className={`w-full py-3 rounded-xl text-white flex items-center justify-center gap-2 ${
                loading ? "bg-gray-600" : "bg-gradient-to-r from-blue-500 to-indigo-600"
              }`}
            >
        ...
        <div className="w-80 flex flex-col justify-center">
          <div className="bg-gray-800/90 p-4 rounded-xl">
            ...
            <a
              href="/login"
              className="w-full py-3 bg-indigo-600 text-white rounded-xl flex items-center justify-center gap-2 hover:bg-indigo-700"
            >
